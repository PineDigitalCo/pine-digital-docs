...
description: "Enhancements designed specifically for the RafflePress WordPress plugin."
---

A WordPress plugin that connects RafflePress giveaways to FluentCRM: auto-add email-verified entrants to a list (with optional tags), plus bulk importing of past entrants.
