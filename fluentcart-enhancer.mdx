...
description: "Enhancements designed specifically for the FluentCart WordPress plugin."
---
...
FluentCart’s short description field is plain text only. **FluentCart Enhancer gives you a compact rich editor—bold, italics, lists, and links—so product blurbs can mean and do more.**

**Off by default.** Enable by going to **Pine Digital → FluentCart Enhancer → Product Description →** Enable **HTML Short Description**.