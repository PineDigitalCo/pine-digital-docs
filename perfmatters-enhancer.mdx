...
description: "Enhancements designed specifically for the Perfmatters WordPress plugin."
---

A WordPress plugin that improves how you manage Perfmatters code snippets: list tools (location, bulk edits, and duplicate); condition logic; and a snippet converter to bring JSON exports from other snippet plugins into Perfmatters.
